...
- (void)configControlAction
{
    ...
    [self.videoControl.bigPlayButton addTarget:self action:@selector(bigPlayButtonClick) forControlEvents:UIControlEventTouchUpInside];
...
- (void)bigPlayButtonClick
{
    [self play];
    self.videoControl.playButton.hidden = YES;
    self.videoControl.pauseButton.hidden = NO;
    self.videoControl.bigPlayButton.hidden = YES;
...
- (void)pauseButtonClick
{
    ...
    self.videoControl.playButton.hidden = NO;
    self.videoControl.pauseButton.hidden = YES;
    self.videoControl.bigPlayButton.hidden = NO;
...
- (void)setTimeLabelValues:(double)currentTime totalTime:(double)totalTime {
    ...
    self.videoControl.timeLabel.text = timeElapsedString;//[NSString stringWithFormat:@"%@/%@",timeElapsedString,timeRmainingString];
